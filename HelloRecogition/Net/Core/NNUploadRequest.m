...
@interface NNUploadRequest ()

@end

@implementation NNUploadRequest
...
- (NSString *)requestURLString {
    return [[NNNetConfigure share].fileUploadURL stringByAppendingString:@"?type=1"];
}
...
+ (nullable NSString *)fileWithName:(nullable NSString *)sName {
    ...
    return [[NNNetConfigure share].fileViewURL stringByAppendingString:sName];
}
@end
